...
const EditAndDeleteModal = (props) => {
    ...
    return (
        <Dialog open={props.formModal2} onClose={props.handleOpenModal} aria-labelledby="form-dialog-title" maxWidth="md">
            <DialogTitle id="form-dialog-title">Update and Delete Rates</DialogTitle>
            <DialogContent>
                <DialogContentText>
                    To update rates, never leave an field empty. To delete, just click on delete button at the bottom of the form.
          </DialogContentText>
                <Formik
                    initialValues={{
                        _id:props.selectedRate._id,
                        Provider:props.selectedRate.Provider,
                        Country: props.selectedRate.Country,
                        Rate: props.selectedRate.Rate,
                        Tax: props.selectedRate.Tax,
                        Fee: props.selectedRate.Fee,
                        AmountReceivable:props.selectedRate.AmountReceivable,
                        TransferTime: props.selectedRate.TransferTime,
                        Name: props.selectedRate.Name,
                        WebsiteURL: props.selectedRate.WebsiteURL
                    }}
                    validationSchema={
                        Yup.object().shape({
            ...
            <DialogActions>
                <Button onClick={props.handleOpenModal.bind(this,false)} color="primary">
                    Cancel
                </Button>
                <Button onClick={props.deleteRate} color="primary">
                    Delete
                </Button>
